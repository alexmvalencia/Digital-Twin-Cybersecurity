...
#include "px4/msg/detail/rover_differential_status__rosidl_typesupport_fastrtps_c.h"
...
using _RoverDifferentialStatus__ros_msg_type = px4__msg__RoverDifferentialStatus;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4
bool cdr_serialize_px4__msg__RoverDifferentialStatus(
  const px4__msg__RoverDifferentialStatus * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4
bool cdr_deserialize_px4__msg__RoverDifferentialStatus(
  eprosima::fastcdr::Cdr & cdr,
  px4__msg__RoverDifferentialStatus * ros_message)
{
  // Field name: timestamp
  {
    cdr >> ros_message->timestamp;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4
size_t get_serialized_size_px4__msg__RoverDifferentialStatus(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4
size_t max_serialized_size_px4__msg__RoverDifferentialStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4__msg__RoverDifferentialStatus;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4
bool cdr_serialize_key_px4__msg__RoverDifferentialStatus(
  const px4__msg__RoverDifferentialStatus * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: timestamp
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4
size_t get_serialized_size_key_px4__msg__RoverDifferentialStatus(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RoverDifferentialStatus__ros_msg_type * ros_message = static_cast<const _RoverDifferentialStatus__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4
size_t max_serialized_size_key_px4__msg__RoverDifferentialStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const px4__msg__RoverDifferentialStatus * ros_message = static_cast<const px4__msg__RoverDifferentialStatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_px4__msg__RoverDifferentialStatus(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  px4__msg__RoverDifferentialStatus * ros_message = static_cast<px4__msg__RoverDifferentialStatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_px4__msg__RoverDifferentialStatus(cdr, ros_message);
}

static uint32_t _RoverDifferentialStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_px4__msg__RoverDifferentialStatus(
...
static size_t _RoverDifferentialStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_px4__msg__RoverDifferentialStatus(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4, msg, RoverDifferentialStatus)() {
