  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const px4__msg__TrajectoryWaypoint * ros_message = static_cast<const px4__msg__TrajectoryWaypoint *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_px4__msg__TrajectoryWaypoint(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  px4__msg__TrajectoryWaypoint * ros_message = static_cast<px4__msg__TrajectoryWaypoint *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_px4__msg__TrajectoryWaypoint(cdr, ros_message);
}
