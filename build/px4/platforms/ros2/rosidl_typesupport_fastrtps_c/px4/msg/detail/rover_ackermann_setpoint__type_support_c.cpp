...
#include "px4/msg/detail/rover_ackermann_setpoint__rosidl_typesupport_fastrtps_c.h"
...
using _RoverAckermannSetpoint__ros_msg_type = px4__msg__RoverAckermannSetpoint;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4
bool cdr_serialize_px4__msg__RoverAckermannSetpoint(
  const px4__msg__RoverAckermannSetpoint * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4
bool cdr_deserialize_px4__msg__RoverAckermannSetpoint(
  eprosima::fastcdr::Cdr & cdr,
  px4__msg__RoverAckermannSetpoint * ros_message)
{
  // Field name: timestamp
  {
    cdr >> ros_message->timestamp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4__msg__RoverAckermannSetpoint;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4
bool cdr_serialize_key_px4__msg__RoverAckermannSetpoint(
  const px4__msg__RoverAckermannSetpoint * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: timestamp
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4
size_t get_serialized_size_key_px4__msg__RoverAckermannSetpoint(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RoverAckermannSetpoint__ros_msg_type * ros_message = static_cast<const _RoverAckermannSetpoint__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4
size_t max_serialized_size_key_px4__msg__RoverAckermannSetpoint(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const px4__msg__RoverAckermannSetpoint * ros_message = static_cast<const px4__msg__RoverAckermannSetpoint *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_px4__msg__RoverAckermannSetpoint(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  px4__msg__RoverAckermannSetpoint * ros_message = static_cast<px4__msg__RoverAckermannSetpoint *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_px4__msg__RoverAckermannSetpoint(cdr, ros_message);
}

static uint32_t _RoverAckermannSetpoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_px4__msg__RoverAckermannSetpoint(
...
static size_t _RoverAckermannSetpoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_px4__msg__RoverAckermannSetpoint(
