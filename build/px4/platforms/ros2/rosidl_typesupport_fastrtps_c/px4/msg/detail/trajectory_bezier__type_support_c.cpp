  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const px4__msg__TrajectoryBezier * ros_message = static_cast<const px4__msg__TrajectoryBezier *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_px4__msg__TrajectoryBezier(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  px4__msg__TrajectoryBezier * ros_message = static_cast<px4__msg__TrajectoryBezier *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_px4__msg__TrajectoryBezier(cdr, ros_message);
}
