...
#include "px4/msg/detail/rover_mecanum_guidance_status__rosidl_typesupport_fastrtps_c.h"
...
using _RoverMecanumGuidanceStatus__ros_msg_type = px4__msg__RoverMecanumGuidanceStatus;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4
bool cdr_serialize_px4__msg__RoverMecanumGuidanceStatus(
  const px4__msg__RoverMecanumGuidanceStatus * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4
bool cdr_deserialize_px4__msg__RoverMecanumGuidanceStatus(
  eprosima::fastcdr::Cdr & cdr,
  px4__msg__RoverMecanumGuidanceStatus * ros_message)
{
  // Field name: timestamp
  {
    cdr >> ros_message->timestamp;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4
size_t get_serialized_size_px4__msg__RoverMecanumGuidanceStatus(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4
size_t max_serialized_size_px4__msg__RoverMecanumGuidanceStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4__msg__RoverMecanumGuidanceStatus;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4
bool cdr_serialize_key_px4__msg__RoverMecanumGuidanceStatus(
  const px4__msg__RoverMecanumGuidanceStatus * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: timestamp
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4
size_t get_serialized_size_key_px4__msg__RoverMecanumGuidanceStatus(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RoverMecanumGuidanceStatus__ros_msg_type * ros_message = static_cast<const _RoverMecanumGuidanceStatus__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4
size_t max_serialized_size_key_px4__msg__RoverMecanumGuidanceStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const px4__msg__RoverMecanumGuidanceStatus * ros_message = static_cast<const px4__msg__RoverMecanumGuidanceStatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_px4__msg__RoverMecanumGuidanceStatus(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  px4__msg__RoverMecanumGuidanceStatus * ros_message = static_cast<px4__msg__RoverMecanumGuidanceStatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_px4__msg__RoverMecanumGuidanceStatus(cdr, ros_message);
}

static uint32_t _RoverMecanumGuidanceStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_px4__msg__RoverMecanumGuidanceStatus(
...
static size_t _RoverMecanumGuidanceStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_px4__msg__RoverMecanumGuidanceStatus(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4, msg, RoverMecanumGuidanceStatus)() {
