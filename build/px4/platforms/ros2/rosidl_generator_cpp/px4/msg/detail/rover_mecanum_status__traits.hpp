...
#ifndef PX4__MSG__DETAIL__ROVER_MECANUM_STATUS__TRAITS_HPP_
#define PX4__MSG__DETAIL__ROVER_MECANUM_STATUS__TRAITS_HPP_
...
inline void to_yaml(
  const px4::msg::RoverMecanumStatus & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const px4::msg::RoverMecanumStatus & msg)
{
  return px4::msg::to_yaml(msg);
}

template<>
inline const char * data_type<px4::msg::RoverMecanumStatus>()
{
  return "px4::msg::RoverMecanumStatus";
}

template<>
inline const char * name<px4::msg::RoverMecanumStatus>()
{
  return "px4/msg/RoverMecanumStatus";
}

template<>
struct has_fixed_size<px4::msg::RoverMecanumStatus>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<px4::msg::RoverMecanumStatus>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<px4::msg::RoverMecanumStatus>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // PX4__MSG__DETAIL__ROVER_MECANUM_STATUS__TRAITS_HPP_
