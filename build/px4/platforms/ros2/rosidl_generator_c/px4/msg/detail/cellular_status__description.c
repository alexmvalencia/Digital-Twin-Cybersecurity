...
px4__msg__CellularStatus__get_type_hash(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  static rosidl_type_hash_t hash = {1, {
      0x2d, 0xda, 0xd7, 0x18, 0xc8, 0xde, 0x60, 0x35,
      0x78, 0xc6, 0xc2, 0x3d, 0x9a, 0xed, 0x59, 0xd2,
      0xce, 0x36, 0x71, 0x48, 0x0f, 0x02, 0x6e, 0x49,
      0x13, 0xe7, 0x09, 0xbf, 0xb5, 0xcc, 0xc0, 0x29,
    }};
  return &hash;
}
...
static char px4__msg__CellularStatus__TYPE_NAME[] = "px4/msg/CellularStatus";

// Define type names, field names, and default values
static char px4__msg__CellularStatus__FIELD_NAME__timestamp[] = "timestamp";
static char px4__msg__CellularStatus__FIELD_NAME__status[] = "status";
static char px4__msg__CellularStatus__FIELD_NAME__failure_reason[] = "failure_reason";
static char px4__msg__CellularStatus__FIELD_NAME__type[] = "type";
static char px4__msg__CellularStatus__FIELD_NAME__quality[] = "quality";
static char px4__msg__CellularStatus__FIELD_NAME__mcc[] = "mcc";
static char px4__msg__CellularStatus__FIELD_NAME__mnc[] = "mnc";
static char px4__msg__CellularStatus__FIELD_NAME__lac[] = "lac";

static rosidl_runtime_c__type_description__Field px4__msg__CellularStatus__FIELDS[] = {
  {
    {px4__msg__CellularStatus__FIELD_NAME__timestamp, 9, 9},
    {
  ...
  {
    {px4__msg__CellularStatus__FIELD_NAME__status, 6, 6},
    {
  ...
  {
    {px4__msg__CellularStatus__FIELD_NAME__failure_reason, 14, 14},
    {
  ...
  {
    {px4__msg__CellularStatus__FIELD_NAME__type, 4, 4},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_UINT8,
      0,
      0,
  ...
  {
    {px4__msg__CellularStatus__FIELD_NAME__quality, 7, 7},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_UINT8,
      0,
      0,
  ...
  {
    {px4__msg__CellularStatus__FIELD_NAME__mcc, 3, 3},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_UINT16,
      0,
      0,
  ...
  {
    {px4__msg__CellularStatus__FIELD_NAME__mnc, 3, 3},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_UINT16,
      0,
      0,
  ...
  {
    {px4__msg__CellularStatus__FIELD_NAME__lac, 3, 3},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_UINT16,
      0,
      0,
...
px4__msg__CellularStatus__get_type_description(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {px4__msg__CellularStatus__TYPE_NAME, 22, 22},
      {px4__msg__CellularStatus__FIELDS, 8, 8},
    },
    {NULL, 0, 0},
  };
  if (!constructed) {
...
px4__msg__CellularStatus__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
...
px4__msg__CellularStatus__get_type_description_sources(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *px4__msg__CellularStatus__get_individual_type_description_source(NULL),
    constructed = true;
  }
