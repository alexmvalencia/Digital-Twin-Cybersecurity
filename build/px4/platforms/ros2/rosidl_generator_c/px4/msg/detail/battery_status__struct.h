...
// IWYU pragma: private, include "px4/msg/battery_status.h"
...
enum
{
  px4__msg__BatteryStatus__MESSAGE_VERSION = 0ul
};
...
enum
{
  px4__msg__BatteryStatus__BATTERY_FAULT_FAILED_TO_ARM = 10
};
