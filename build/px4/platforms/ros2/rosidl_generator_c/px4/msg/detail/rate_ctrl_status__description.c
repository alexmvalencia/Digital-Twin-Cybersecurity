  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0x52, 0xbd, 0xe8, 0x5a, 0x65, 0xf1, 0x93, 0x4b,
      0x9f, 0x32, 0x9b, 0xce, 0xb3, 0x77, 0x9f, 0xcb,
      0xdc, 0xd5, 0xc4, 0x96, 0x02, 0x9c, 0x61, 0x66,
      0x70, 0x16, 0xd7, 0xdf, 0x25, 0xdf, 0x1b, 0x7e,
    }};
  return &hash;
}
...
static char px4__msg__RateCtrlStatus__FIELD_NAME__wheel_rate_integ[] = "wheel_rate_integ";
...
static rosidl_runtime_c__type_description__Field px4__msg__RateCtrlStatus__FIELDS[] = {
  ...
  {
    {px4__msg__RateCtrlStatus__FIELD_NAME__wheel_rate_integ, 16, 16},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_FLOAT,
      0,
      0,
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {px4__msg__RateCtrlStatus__FIELDS, 5, 5},
    },
    {NULL, 0, 0},
  };
  if (!constructed) {
