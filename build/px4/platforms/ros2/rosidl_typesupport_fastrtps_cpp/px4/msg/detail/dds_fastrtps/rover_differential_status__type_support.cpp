...
#include "px4/msg/detail/rover_differential_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const px4::msg::RoverDifferentialStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  px4::msg::RoverDifferentialStatus & ros_message)
{
  // Member: timestamp
  cdr >> ros_message.timestamp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4::msg::RoverDifferentialStatus;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_px4
max_serialized_size_key_RoverDifferentialStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const px4::msg::RoverDifferentialStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<px4::msg::RoverDifferentialStatus *>(
    untyped_ros_message);
...
{
  return &px4::msg::typesupport_fastrtps_cpp::_RoverDifferentialStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4, msg, RoverDifferentialStatus)() {
  return &px4::msg::typesupport_fastrtps_cpp::_RoverDifferentialStatus__handle;
}
