...
#include "px4/msg/detail/rover_ackermann_setpoint__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4::msg::RoverAckermannSetpoint;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_px4
max_serialized_size_key_RoverAckermannSetpoint(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const px4::msg::RoverAckermannSetpoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<px4::msg::RoverAckermannSetpoint *>(
    untyped_ros_message);
...
static size_t _RoverAckermannSetpoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RoverAckermannSetpoint(full_bounded, is_plain, 0);
...
{
  return &px4::msg::typesupport_fastrtps_cpp::_RoverAckermannSetpoint__handle;
}
