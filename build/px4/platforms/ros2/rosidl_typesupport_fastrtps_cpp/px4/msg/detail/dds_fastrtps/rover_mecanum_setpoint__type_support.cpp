...
#include "px4/msg/detail/rover_mecanum_setpoint__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const px4::msg::RoverMecanumSetpoint & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  px4::msg::RoverMecanumSetpoint & ros_message)
{
  // Member: timestamp
  cdr >> ros_message.timestamp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4::msg::RoverMecanumSetpoint;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_px4
max_serialized_size_key_RoverMecanumSetpoint(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const px4::msg::RoverMecanumSetpoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<px4::msg::RoverMecanumSetpoint *>(
    untyped_ros_message);
...
{
  return &px4::msg::typesupport_fastrtps_cpp::_RoverMecanumSetpoint__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4, msg, RoverMecanumSetpoint)() {
  return &px4::msg::typesupport_fastrtps_cpp::_RoverMecanumSetpoint__handle;
}
