...
#include "px4/msg/detail/rover_mecanum_guidance_status__type_support.h"
...
static const _RoverMecanumGuidanceStatus_type_support_symbol_names_t _RoverMecanumGuidanceStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4, msg, RoverMecanumGuidanceStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, px4, msg, RoverMecanumGuidanceStatus)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, px4, msg, RoverMecanumGuidanceStatus)() {
  return &::px4::msg::rosidl_typesupport_c::RoverMecanumGuidanceStatus_message_type_support_handle;
}
