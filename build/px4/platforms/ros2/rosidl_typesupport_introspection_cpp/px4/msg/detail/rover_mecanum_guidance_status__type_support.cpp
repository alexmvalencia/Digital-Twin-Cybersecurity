...
{
  new (message_memory) px4::msg::RoverMecanumGuidanceStatus(_init);
}

void RoverMecanumGuidanceStatus_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4::msg::RoverMecanumGuidanceStatus *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RoverMecanumGuidanceStatus_message_member_array[4] = {
  {
    ...
    offsetof(px4::msg::RoverMecanumGuidanceStatus, timestamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::RoverMecanumGuidanceStatus, lookahead_distance),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::RoverMecanumGuidanceStatus, heading_error),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::RoverMecanumGuidanceStatus, desired_speed),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers RoverMecanumGuidanceStatus_message_members = {
  ...
  4,  // number of fields
  sizeof(px4::msg::RoverMecanumGuidanceStatus),
...
get_message_type_support_handle<px4::msg::RoverMecanumGuidanceStatus>()
{
  return &::px4::msg::rosidl_typesupport_introspection_cpp::RoverMecanumGuidanceStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4, msg, RoverMecanumGuidanceStatus)() {
  return &::px4::msg::rosidl_typesupport_introspection_cpp::RoverMecanumGuidanceStatus_message_type_support_handle;
}
