...
{
  const auto & item = *reinterpret_cast<const px4::msg::TrajectoryWaypoint *>(
    get_const_function__VehicleTrajectoryWaypoint__waypoints(untyped_member, index));
  auto & value = *reinterpret_cast<px4::msg::TrajectoryWaypoint *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<px4::msg::TrajectoryWaypoint *>(
    get_function__VehicleTrajectoryWaypoint__waypoints(untyped_member, index));
  const auto & value = *reinterpret_cast<const px4::msg::TrajectoryWaypoint *>(untyped_value);
  item = value;
}
