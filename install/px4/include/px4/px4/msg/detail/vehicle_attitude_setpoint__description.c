  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0x78, 0xa7, 0x9b, 0xce, 0x42, 0x5b, 0xcb, 0xbd,
      0x66, 0x17, 0x57, 0x1c, 0x12, 0x08, 0x5c, 0x30,
      0x0d, 0x0d, 0x31, 0x60, 0xdb, 0x5b, 0x17, 0x40,
      0x51, 0x94, 0x51, 0x4a, 0xd8, 0x16, 0xd1, 0x03,
    }};
  return &hash;
}
...
static char px4__msg__VehicleAttitudeSetpoint__FIELD_NAME__reset_integral[] = "reset_integral";
static char px4__msg__VehicleAttitudeSetpoint__FIELD_NAME__fw_control_yaw_wheel[] = "fw_control_yaw_wheel";
...
static rosidl_runtime_c__type_description__Field px4__msg__VehicleAttitudeSetpoint__FIELDS[] = {
  ...
  {
    {px4__msg__VehicleAttitudeSetpoint__FIELD_NAME__reset_integral, 14, 14},
    {
  ...
  {
    {px4__msg__VehicleAttitudeSetpoint__FIELD_NAME__fw_control_yaw_wheel, 20, 20},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_BOOLEAN,
      0,
      0,
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {px4__msg__VehicleAttitudeSetpoint__FIELDS, 6, 6},
    },
    {NULL, 0, 0},
  };
  if (!constructed) {
