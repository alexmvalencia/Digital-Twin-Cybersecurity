...
{
  const auto & item = *reinterpret_cast<const px4::msg::TrajectoryBezier *>(
    get_const_function__VehicleTrajectoryBezier__control_points(untyped_member, index));
  auto & value = *reinterpret_cast<px4::msg::TrajectoryBezier *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<px4::msg::TrajectoryBezier *>(
    get_function__VehicleTrajectoryBezier__control_points(untyped_member, index));
  const auto & value = *reinterpret_cast<const px4::msg::TrajectoryBezier *>(untyped_value);
  item = value;
}
