...
// IWYU pragma: private, include "px4/msg/vehicle_trajectory_bezier.hpp"
...
inline void to_yaml(
  const px4::msg::VehicleTrajectoryBezier & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const px4::msg::VehicleTrajectoryBezier & msg)
{
