  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0x9b, 0x99, 0xca, 0xc0, 0xdd, 0x37, 0xa2, 0x62,
      0xa2, 0x67, 0xc0, 0xda, 0xd4, 0xb4, 0xaa, 0x8b,
      0x3e, 0x39, 0xda, 0xaa, 0x54, 0x35, 0x87, 0xce,
      0xb4, 0x29, 0x20, 0xd6, 0x09, 0xc3, 0xa4, 0x05,
    }};
  return &hash;
}
...
static char px4__msg__PositionControllerStatus__FIELD_NAME__yaw_acceptance[] = "yaw_acceptance";
static char px4__msg__PositionControllerStatus__FIELD_NAME__altitude_acceptance[] = "altitude_acceptance";
...
static rosidl_runtime_c__type_description__Field px4__msg__PositionControllerStatus__FIELDS[] = {
  ...
  {
    {px4__msg__PositionControllerStatus__FIELD_NAME__yaw_acceptance, 14, 14},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_FLOAT,
      0,
      0,
  ...
  {
    {px4__msg__PositionControllerStatus__FIELD_NAME__altitude_acceptance, 19, 19},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_FLOAT,
      0,
      0,
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {px4__msg__PositionControllerStatus__FIELDS, 11, 11},
    },
    {NULL, 0, 0},
  };
  if (!constructed) {
